  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-3/12 absolute p-12 bg-black my-24 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-70"
      >
        ...
        <button
          className="p-4 my-6 bg-red-600 w-full rounded font-bold text-white hover:bg-red-700"
        ...
        <div className="text-center my-6">
          <p
            className="text-white py-4 font-semibold cursor-pointer"
